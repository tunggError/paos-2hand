      ...
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <button 
            ...
            className="p-2 text-gray-900 bg-white border-2 border-gray-900 shadow-[2px_2px_0px_0px_rgba(17,24,39,1)] hover:bg-olive-600 hover:text-white transition-colors relative"
          >
            ...
            <span className="absolute -top-2 -right-2 w-5 h-5 bg-red-600 border-2 border-gray-900 text-white text-[10px] font-black flex items-center justify-center">
              {cart.length}
            </span>
          </button>
